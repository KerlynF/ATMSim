...
namespace ATMSim
{
    public interface IAutorizador
    {
        ...
        public string CrearCuenta(TipoCuenta tipo, double montoDeApertura = 0, int sobregiro = 0);
    ...
    public class Autorizador : IAutorizador
    {
        ...
        public string CrearCuenta(TipoCuenta tipo, double montoDeApertura = 0, int sobregiro = 0)
        {
            ...
            Cuenta cuenta = new Cuenta(numero, tipo, Math.Round(montoDeApertura, 2), sobregiro);
            cuentas.Add(cuenta);
